...
export const EventIcon: React.FC<Props> = ({ className, variant, emoji, title, eventSlug, userId }) => {
    return (
        <a href={variant == 'create' ? PUBLIC_URL.eventCreate() : PUBLIC_URL.eventSlug(userId, eventSlug)} className={cn('group flex flex-col items-center ml-0 max-w-[77.5px]', className)}>
