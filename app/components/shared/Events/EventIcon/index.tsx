...
export const EventIcon: React.FC<Props> = ({ className, variant, emoji, title, eventLink, userId }) => {
    return (
        <a href={variant == 'create' ? "/events/create" : `/events/${userId}/${eventLink}`} className={cn('group flex flex-col items-center ml-0 max-w-[77.5px]', className)}>
